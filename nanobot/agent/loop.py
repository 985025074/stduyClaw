...
if TYPE_CHECKING:
    from nanobot.config.schema import AcademicToolsConfig, ChannelsConfig, ExecToolConfig
...
class AgentLoop:
    ...
    def _register_default_tools(self) -> None:
        ...
        self.tools.register(AcademicSearchTool(config=self.academic_config, proxy=self.web_proxy))
